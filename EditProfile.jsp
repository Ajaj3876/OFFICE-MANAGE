...
<div>
    ...
    if(db.rst.next())
    {
        out.println("<form action=#>");
            ...
            out.println("<tr><td width='300'><input type='submit' value='Update'></td><td><input type='reset' value='Reset'></td></tr>");
    ...
    if(i>0)
    {
        response.sendRedirect("EmployeeHome.jsp?msg=Profile Updted Successfully");
    }
